module.exports = function (migration) {
  ...
  hero.createField('headline').name('Headline').type('Symbol').required(true).localized(true)
  hero.createField('subheadline').name('Subheadline').type('Text').localized(true)
  hero.createField('eyebrow').name('Eyebrow').type('Symbol').localized(true)
  hero.createField('image').name('Image').type('Link').linkType('Asset')
  hero.createField('ctaLabel').name('CTA Label').type('Symbol').localized(true)
  ...
  whoWeAre.createField('headline').name('Headline').type('Symbol').required(true).localized(true)
  whoWeAre.createField('subheadline').name('Subheadline').type('Text').required(true).localized(true)
  ...
  solutions.createField('title').name('Title').type('Symbol').localized(true)
  solutions.createField('description').name('Description').type('Text').localized(true)
  ...
  solutionItem.createField('title').name('Title').type('Symbol').required(true).localized(true)
  solutionItem.createField('description').name('Description').type('Text').required(true).localized(true)
  ...
  brandsWall.createField('title').name('Title').type('Symbol').localized(true)
  ...
  brandItem.createField('name').name('Name').type('Symbol').required(true).localized(true)
  ...
  servicesGrid.createField('title').name('Title').type('Symbol').localized(true)
  ...
  serviceItem.createField('title').name('Title').type('Symbol').required(true).localized(true)
  serviceItem.createField('description').name('Description').type('Text').required(true).localized(true)
  ...
  coverage.createField('title').name('Title').type('Symbol').localized(true)
  coverage.createField('regions').name('Regions').type('Array').items({ type: 'Symbol' }).localized(true)
  coverage.displayField('title')

  // Section: Why Us
  const whyUs = migration.createContentType('whyUs').name('Section: Why Us')
  whyUs.createField('title').name('Title').type('Symbol').localized(true)
  whyUs.createField('bullets').name('Bullets').type('Array').items({ type: 'Symbol' }).localized(true)
  ...
  snapshot.createField('title').name('Title').type('Symbol').localized(true)
  ...
  metricItem.createField('value').name('Value').type('Symbol').required(true).localized(true)
  metricItem.createField('label').name('Label').type('Symbol').required(true).localized(true)
  ...
  valuesGrid.createField('title').name('Title').type('Symbol').localized(true)
  ...
  valueItem.createField('title').name('Title').type('Symbol').required(true).localized(true)
  valueItem.createField('description').name('Description').type('Text').required(true).localized(true)
  ...
  cta.createField('headline').name('Headline').type('Symbol').localized(true)
  cta.createField('subheadline').name('Subheadline').type('Text').localized(true)
  cta.createField('ctaLabel').name('CTA Label').type('Symbol').localized(true)
  ...
  contactForm.createField('internalTitle').name('Internal Title').type('Symbol').required(true)
  ...
  solutionsShowcase.createField('internalTitle').name('Internal Title for UI').type('Symbol').required(true)
  solutionsShowcase.createField('items').name('Items').type('Array').items({
    type: 'Link',
    linkType: 'Entry',
    validations: [{ linkContentType: ['solutionShowcaseItem'] }],
  })
  solutionsShowcase.displayField('internalTitle')
  ...
  solutionShowcaseItem.createField('title').name('Title').type('Symbol').required(true).localized(true)
  solutionShowcaseItem.createField('description').name('Description').type('Text').required(true).localized(true)
  solutionShowcaseItem.createField('extended_description').name('Extended Description').type('Text').localized(true)
  solutionShowcaseItem.createField('image').name('Image').type('Link').linkType('Asset').required(true)
  solutionShowcaseItem.createField('features').name('Features').type('Array').items({ type: 'Symbol' }).localized(true)
  ...
  sectorsGrid.createField('internalTitle').name('Internal Title for UI').type('Symbol').required(true)
  sectorsGrid.createField('items').name('Items').type('Array').items({
    type: 'Link',
    linkType: 'Entry',
    validations: [{ linkContentType: ['sectorItem'] }],
  })
  sectorsGrid.displayField('internalTitle')

  // Reusable: Sector Item
  const sectorItem = migration.createContentType('sectorItem').name('Reusable: Sector Item')
  sectorItem.createField('title').name('Title').type('Symbol').required(true).localized(true)
  sectorItem.createField('description').name('Description').type('Text').localized(true)
  ...
  partnersShowcase.createField('internalTitle').name('Internal Title for UI').type('Symbol').required(true)
  partnersShowcase.createField('items').name('Items').type('Array').items({
    type: 'Link',
    linkType: 'Entry',
    validations: [{ linkContentType: ['partnerItem'] }],
  })
  partnersShowcase.displayField('internalTitle')

  // Reusable: Partner Item
  const partnerItem = migration.createContentType('partnerItem').name('Reusable: Partner Item')
  partnerItem.createField('name').name('Name').type('Symbol').required(true).localized(true)
  partnerItem.createField('logo').name('Logo').type('Link').linkType('Asset').required(true)
  partnerItem.createField('description').name('Description').type('Text').localized(true)
  partnerItem.createField('features').name('Features').type('Array').items({ type: 'Symbol' }).localized(true)
  partnerItem.createField('fit').name('Why They Fit').type('Text').localized(true)
  partnerItem.displayField('name')
    ...
    servicesGridPage.createField('internalTitle').name('Internal Title for UI').type('Symbol').required(true)
    servicesGridPage.createField('items').name('Items').type('Array').items({
      type: 'Link',
      linkType: 'Entry',
      validations: [{ linkContentType: ['serviceItem'] }],
    })
    servicesGridPage.displayField('internalTitle')
  ...
  page.createField('title').name('Title').type('Symbol').required(true).localized(true)
  
  const slugField = page.createField('slug').name('Slug').type('Symbol').required(true).localized(true)
